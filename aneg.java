...
public class aneg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ListView) findViewById(R.id.listView9);
    ...
    protected void showList(String response){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    aneg.this, personList, R.layout.listview4,
    ...
    public void getData() {
        ...
        String url ="http://192.168.43.219/app/an.php";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(aneg.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
