...
public class abpos extends AppCompatActivity {
    ...
    protected void showList(String response){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    abpos.this, personList, R.layout.listview4,
    ...
    public void getData() {
        ...
        String url ="http://192.168.43.219/app/abp.php";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(abpos.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
