...
public class abneg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ListView) findViewById(R.id.listView15);
    ...
    protected void showList(String response){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    abneg.this, personList, R.layout.listview4,
    ...
    public void getData() {
        ...
        String url ="http://192.168.43.219/app/abn.php";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(abneg.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
