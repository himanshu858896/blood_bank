...
public class oneg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ListView) findViewById(R.id.listView14);
    ...
    protected void showList(String response){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    oneg.this, personList, R.layout.listview4,
    ...
    public void getData() {
        ...
        String url ="http://192.168.43.219/app/on.php";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(oneg.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
